...
const ActividadesCuenca = () => {
  const activities = [
    ...
    },
    {
      ...
      description: "Descubre los mejores sectores de escalada del oriente de Asturias. Desde iniciación hasta nivel avanzado, disfruta de vías equipadas en roca de caliza de excelente calidad.",
      image: lagosCovadongaImage,
      duration: "2-8 horas",
      location: "Oriente de Asturias",
                  ...
                  <div className="grid md:grid-cols-2 gap-0">
                    ...
                    <div className="p-6">
                      ...
                      <CardContent className="p-0">
                        ...
                        ) : activity.hasMoreInfo && activity.title === "Paseos a Caballo" ? (
                          <Link to="/rutas-caballo">
                            <Button
                              variant="secondary"
                              className="bg-nature-green hover:bg-nature-forest text-white border-none font-semibold px-6 py-2 shadow-nature transition-all duration-300 hover:shadow-lg"
                            >
